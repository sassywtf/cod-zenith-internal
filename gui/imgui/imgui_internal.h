...
inline ImColor main_color = { 0, 162, 232, 255 };
...
//#endif
    ...
    IMGUI_API void          GetTypematicRepeatRate2(ImGuiInputFlags flags, float* repeat_delay, float* repeat_rate);
    ...
    inline void RenderArrow2(ImVec2 pos, ImGuiDir dir, float scale = 1.0f) { ImGuiWindow* window = GetCurrentWindow(); RenderArrow(window->DrawList, pos, GetColorU32(ImGuiCol_Text), dir, scale); }
