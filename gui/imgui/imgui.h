...
namespace ImGui
{
    ...
    IMGUI_API bool          TabButtonEx(const char* ico, const char* label, bool selected, const ImVec2& size_arg, ImGuiButtonFlags flags = 0);
    IMGUI_API bool          TabButton(const char* ico, const char* label, bool selected, const ImVec2& size_arg);
    ...
    IMGUI_API bool          Tab_New(const char* label, bool selected, const ImVec2& size_arg, ImGuiButtonFlags flags);
...
struct ImFontGlyph
{
    ...
    float           AdvanceX;           // Distance to next character (= data from font + ImFontGlyphExtraSpacing.x baked in)
