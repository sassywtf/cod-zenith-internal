...
//{
//#ifdef _KERNEL_MODE
//	typedef unsigned __int64  std::uintptr_t, size_t;
...
//		const std::uintptr_t xor_key = 0xff00ff00ff00ff00;
//		void* ret_addr_in_stack = 0;
//
//		SpoofFunction(void* addr) :ret_addr_in_stack(addr)
//		{
//			temp = *(std::uintptr_t*)ret_addr_in_stack;
//			temp ^= xor_key;
//			*(std::uintptr_t*)ret_addr_in_stack = 0;
//		}
//		~SpoofFunction()
//		{
//			temp ^= xor_key;
//			*(std::uintptr_t*)ret_addr_in_stack = temp;
//		}
//	};
//
//#ifdef _KERNEL_MODE
...
//		std::uintptr_t temp = *(std::uintptr_t*)ret_addr_in_stack;
//		temp ^= xor_key;
//		*(std::uintptr_t*)ret_addr_in_stack = 0;
//
